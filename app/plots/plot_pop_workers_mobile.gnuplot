set terminal pngcairo size 700,280 enhanced font ",10"
set output "/var/www/html/worldsim/pop_workers_mobile.png"
...
set title "Population & Workers (≈ 24 sim years)" tc rgb "#4c4f69"
